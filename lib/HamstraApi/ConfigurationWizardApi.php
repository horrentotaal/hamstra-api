...
class ConfigurationWizardApi
{
     ...
     * @return \Horrentotaal\HamstraApi\Model\HamstraAPIModelsConfigurationWizardConfigurationWizardEmbedUrl[]
     */
     ...
     * @throws \Horrentotaal\HamstraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Horrentotaal\HamstraApi\Model\HamstraAPIModelsConfigurationWizardConfigurationWizardEmbedUrl[], HTTP status code, HTTP response headers (array of strings)
     */
    public function configurationWizardGetWithHttpInfo($language = null)
    {
        $returnType = '\Horrentotaal\HamstraApi\Model\HamstraAPIModelsConfigurationWizardConfigurationWizardEmbedUrl[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Horrentotaal\HamstraApi\Model\HamstraAPIModelsConfigurationWizardConfigurationWizardEmbedUrl[]',
