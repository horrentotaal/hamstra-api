...
class ProductApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProductDetail, HTTP status code, HTTP response headers (array of strings)
     */
    public function productGetByIdWithHttpInfo($product_id, $consumer_price = null, $include_wizard_items = null, $full_detail = null)
    {
        $returnType = '\Swagger\Client\Model\ProductDetail';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ProductDetail',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function productGetConfigurationAsync($product_id, $current_config_consumer_price = null, $current_config_without_discount = null, $current_config_options = null)
    {
        list($response) = $this->productGetConfigurationAsyncWithHttpInfo($product_id, $current_config_consumer_price, $current_config_without_discount, $current_config_options);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProductConfig, HTTP status code, HTTP response headers (array of strings)
     */
    public function productGetConfigurationAsyncWithHttpInfo($product_id, $current_config_consumer_price = null, $current_config_without_discount = null, $current_config_options = null)
    {
        $returnType = '\Swagger\Client\Model\ProductConfig';
        $request = $this->productGetConfigurationAsyncRequest($product_id, $current_config_consumer_price, $current_config_without_discount, $current_config_options);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ProductConfig',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetConfigurationAsyncAsync($product_id, $current_config_consumer_price = null, $current_config_without_discount = null, $current_config_options = null)
    {
        return $this->productGetConfigurationAsyncAsyncWithHttpInfo($product_id, $current_config_consumer_price, $current_config_without_discount, $current_config_options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetConfigurationAsyncAsyncWithHttpInfo($product_id, $current_config_consumer_price = null, $current_config_without_discount = null, $current_config_options = null)
    {
        $returnType = '\Swagger\Client\Model\ProductConfig';
        $request = $this->productGetConfigurationAsyncRequest($product_id, $current_config_consumer_price, $current_config_without_discount, $current_config_options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productGetConfigurationAsyncRequest($product_id, $current_config_consumer_price = null, $current_config_without_discount = null, $current_config_options = null)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  int $product_id The ID of the product (required)
     * @param  \Swagger\Client\Model\ProductConfigRequest $current_config The current configuration (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ProductConfig
     */
    public function productGetConfigurationAsync_0($product_id, $current_config)
    {
        list($response) = $this->productGetConfigurationAsync_0WithHttpInfo($product_id, $current_config);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\ProductConfig, HTTP status code, HTTP response headers (array of strings)
     */
    public function productGetConfigurationAsync_0WithHttpInfo($product_id, $current_config)
    {
        $returnType = '\Swagger\Client\Model\ProductConfig';
        $request = $this->productGetConfigurationAsync_0Request($product_id, $current_config);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetConfigurationAsync_0Async($product_id, $current_config)
    {
        return $this->productGetConfigurationAsync_0AsyncWithHttpInfo($product_id, $current_config)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetConfigurationAsync_0AsyncWithHttpInfo($product_id, $current_config)
    {
        $returnType = '\Swagger\Client\Model\ProductConfig';
        $request = $this->productGetConfigurationAsync_0Request($product_id, $current_config);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productGetConfigurationAsync_0Request($product_id, $current_config)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ValidationMessageDTO[], HTTP status code, HTTP response headers (array of strings)
     */
    public function productGetValidationMessagesAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\ValidationMessageDTO[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ValidationMessageDTO[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
