...
class OrderApi
{
     ...
     * Creates the order
     *
     * @param  \Swagger\Client\Model\OrderRequest $order_request The order to create (required)
     *
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\KeyValuePairObjectListOrderValidationMessage[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Model\OrderQuotation $order_quotation The quotations to order (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
     ...
     *
     * @param  \Swagger\Client\Model\OrderRequest $order_request The order to quote (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
     ...
     *
     * @param  \Swagger\Client\Model\OrderRequest $order_request The order to create/update (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
     ...
     * Updates the order
     *
     * @param  \Swagger\Client\Model\OrderRequest $order_request The order to update (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
     ...
     * Validate the order
     *
     * @param  \Swagger\Client\Model\OrderRequest $order_request  (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OrderRequest, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderValidateAsyncWithHttpInfo($order_request)
    {
        $returnType = '\Swagger\Client\Model\OrderRequest';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OrderRequest',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
